                ...
                <form onSubmit={handleSubmit}>
                    <div className="p-6">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-2xl font-bold text-gray-800">Bulk Edit</h2>
                            ...
                            <div className="p-4 border rounded-md">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 text-sm flex-grow">
                                        ...
                                        <input type="text" disabled={!updateDescription} value={description} onChange={e => setDescription(e.target.value)} className="mt-2 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-em-red focus:border-em-red sm:text-sm disabled:bg-gray-100 disabled:text-gray-500" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-4 border rounded-md">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 text-sm flex-grow">
                                        ...
                                        <input type="text" disabled={!updateCategory} value={category} onChange={e => setCategory(e.target.value)} className="mt-2 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-em-red focus:border-em-red sm:text-sm disabled:bg-gray-100 disabled:text-gray-500" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-4 border rounded-md">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 text-sm flex-grow">
                                        ...
                                        <input type="text" disabled={!updateSubCategory} value={subCategory} onChange={e => setSubCategory(e.target.value)} className="mt-2 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-em-red focus:border-em-red sm:text-sm disabled:bg-gray-100 disabled:text-gray-500" />
                                    </div>
                                </div>
                            </div>
                        </div>
